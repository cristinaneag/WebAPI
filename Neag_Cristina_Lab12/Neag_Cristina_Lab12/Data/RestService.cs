...
namespace Neag_Cristina_Lab12.Data
{
    class RestService : IRestService
    {
        ...
        string RestUrl = "https://192.168.0.125:45456/api/shoppinglists/{0}";
        public List<ShoppingList> Items { get; private set; }
        public RestService()
        {
        ...
        public async Task<List<ShoppingList>> RefreshDataAsync()
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Items = JsonConvert.DeserializeObject<List<ShoppingList>>(content);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SaveShoppingListAsync(ShoppingList item, bool isNewItem = true)
        {
            Uri uri = new Uri(string.Format(RestUrl, string.Empty));
            try
            {
